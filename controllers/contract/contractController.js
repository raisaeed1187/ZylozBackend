...
const propertySaveUpdate = async (req,res)=>{
    ...
    try {
            ...
            .input('PlotArea', sql.Decimal(18, 8), formData.PlotArea)
            .input('BuiltUpArea', sql.Decimal(18, 8), formData.BuiltUpArea)
            ...
            .input('PropertyValuation', sql.Decimal(18, 8), formData.PropertyValuation)
...
const locationSaveUpdate = async (req,res)=>{
    ...
    try {
            ...
            .input('TenantId', sql.NVarChar(100), req.authUser.tenantId)
            .input('OrganizationId', sql.NVarChar(100), formData.organizationId || req.authUser.tenantId || null)
