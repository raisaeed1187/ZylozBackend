...
const getInvoiceDetails = async (req, res) => {  
    ...
    try {
        ...
        const invoiceResponse = await pool
            .request()
        ...
        const addOnFieldsResponse = await pool
            .request()
            .input("ID2", sql.NVarChar, null)
            .input("transectionId", sql.NVarChar, Id || null)
            .input("organizationId", sql.NVarChar, organizationId || null)
            .execute("FinTransactionAddtionalFieldValue_Get");

        const journalLedgerResponse = await pool
            .request()
            .input("ID2", sql.NVarChar, null)
